...
const ShadowInitParameters_t ShadowInitParametersDefault = {NULL, AWS_IOT_MQTT_PORT, NULL, NULL,
															NULL, false, NULL};

const ShadowConnectParameters_t ShadowConnectParametersDefault = {NULL,
								  NULL, 0, NULL};

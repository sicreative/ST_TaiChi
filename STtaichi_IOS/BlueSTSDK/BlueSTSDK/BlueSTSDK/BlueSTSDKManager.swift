...
@objc public class BlueSTSDKManager : NSObject{
    ...
    static let BT_RESTORE_KEY = "taichiBTIdentifier"
    ...
    @objc public func discoveryStart(_ timeoutMs:Int, advertiseFilters: [BlueSTSDKAdvertiseFilter] ){
       ...
       // let scanOptions:[String : Any] = [CBCentralManagerScanOptionAllowDuplicatesKey:false]
        ...
        let uuids = [CBUUID(string: "00000000-000D-11E1-9AB4-0002A5D5C51B"),nil]
        mCBCentralManager.scanForPeripherals(withServices: uuids as? [CBUUID], options: nil)
        isDiscovering = true
